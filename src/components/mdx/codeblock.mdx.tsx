...
const CodeblockMDX = ({ className, children }: CodeblockMDXProps) => {
  ...
  return (
    <div className="w-full rounded-md border border-app-border-dark my-2">
      <div className="flex items-center justify-between bg-app-border-dark/60 py-1 px-4 gap-2">
        <div className="flex justify-start items-center gap-2">
          ...
          <span className="text-app-secondary-dark">{language || "code"}</span>
        </div>

        <Clipboard className="inline-block size-3 cursor-pointer" />
      </div>

      <div className="relative max-h-[30rem] flex w-full bg-app-border-dark/20 rounded-b-md overflow-hidden">
        <div className="py-2 px-3 text-right select-none">
